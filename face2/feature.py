...
class Feature:
    ...
    def scale(self, percents, image):
        ...
        self.bounds.x = (self.bounds.w - (self.init_bounds.w * 0.01 * percents))/2 + self.bounds.x
        self.bounds.y = (self.bounds.h - (self.init_bounds.h * 0.01 * percents))/2 + self.bounds.y

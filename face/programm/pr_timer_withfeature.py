...
pupil2 = Feature(305,110,116,117,"../images/onepupil.png")

eyebrows = Feature(0,0,800,480,"../images/eyebrows.png")
eyebrows2 = Feature(0,0,800,480,"../images/eyebrows.png")
...
objects = [background, pupil1, pupil2,  eyebrows, mouth, eyebr, sm]
#eye_socket
